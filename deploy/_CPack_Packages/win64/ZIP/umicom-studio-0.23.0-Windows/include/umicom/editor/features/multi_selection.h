/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/multi_selection.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Multi Selection editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Multiple normalized ranges with primary-selection identity.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_MULTI_SELECTION_H
#define UMICOM_EDITOR_FEATURES_MULTI_SELECTION_H
...
/** Return the canonical Framework descriptor for Multi Selection. */
...
#endif /* UMICOM_EDITOR_FEATURES_MULTI_SELECTION_H */
