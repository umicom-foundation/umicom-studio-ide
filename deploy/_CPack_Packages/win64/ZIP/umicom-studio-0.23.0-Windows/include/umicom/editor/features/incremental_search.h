/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/incremental_search.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Incremental Search editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Search-as-you-type sessions preserving origin and wrap state.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_INCREMENTAL_SEARCH_H
#define UMICOM_EDITOR_FEATURES_INCREMENTAL_SEARCH_H
...
/** Return the canonical Framework descriptor for Incremental Search. */
...
#endif /* UMICOM_EDITOR_FEATURES_INCREMENTAL_SEARCH_H */
