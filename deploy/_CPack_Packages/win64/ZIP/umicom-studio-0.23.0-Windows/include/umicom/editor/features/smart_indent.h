/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/smart_indent.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Smart Indent editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Context-sensitive newline and block indentation requests.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_SMART_INDENT_H
#define UMICOM_EDITOR_FEATURES_SMART_INDENT_H
...
/** Return the canonical Framework descriptor for Smart Indent. */
...
#endif /* UMICOM_EDITOR_FEATURES_SMART_INDENT_H */
