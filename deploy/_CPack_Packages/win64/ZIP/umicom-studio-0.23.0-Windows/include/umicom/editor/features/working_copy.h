/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/working_copy.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Working Copy editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Dirty in-memory resource tracked independently of file I/O.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_WORKING_COPY_H
#define UMICOM_EDITOR_FEATURES_WORKING_COPY_H
...
/** Return the canonical Framework descriptor for Working Copy. */
...
#endif /* UMICOM_EDITOR_FEATURES_WORKING_COPY_H */
