/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/virtual_document.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Virtual Document editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Read-only content supplied by debuggers, diffs and remote providers.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_VIRTUAL_DOCUMENT_H
#define UMICOM_EDITOR_FEATURES_VIRTUAL_DOCUMENT_H
...
/** Return the canonical Framework descriptor for Virtual Document. */
...
#endif /* UMICOM_EDITOR_FEATURES_VIRTUAL_DOCUMENT_H */
