/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/bracket_matching.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Bracket Matching editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Bracket pair discovery with bounded forward and reverse scans.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_BRACKET_MATCHING_H
#define UMICOM_EDITOR_FEATURES_BRACKET_MATCHING_H
...
/** Return the canonical Framework descriptor for Bracket Matching. */
...
#endif /* UMICOM_EDITOR_FEATURES_BRACKET_MATCHING_H */
