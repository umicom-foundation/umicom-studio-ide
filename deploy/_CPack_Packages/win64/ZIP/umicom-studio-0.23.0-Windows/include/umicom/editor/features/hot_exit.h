/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/hot_exit.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Hot Exit editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Restorable unsaved working copies across process restarts.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_HOT_EXIT_H
#define UMICOM_EDITOR_FEATURES_HOT_EXIT_H
...
/** Return the canonical Framework descriptor for Hot Exit. */
...
#endif /* UMICOM_EDITOR_FEATURES_HOT_EXIT_H */
