/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/edit_operation.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Edit Operation editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Atomic insertion, deletion and replacement operations.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_EDIT_OPERATION_H
#define UMICOM_EDITOR_FEATURES_EDIT_OPERATION_H
...
/** Return the canonical Framework descriptor for Edit Operation. */
...
#endif /* UMICOM_EDITOR_FEATURES_EDIT_OPERATION_H */
