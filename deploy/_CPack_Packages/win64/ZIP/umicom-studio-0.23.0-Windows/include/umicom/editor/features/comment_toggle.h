/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/comment_toggle.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Comment Toggle editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Language-provided line and block comment transformations.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_COMMENT_TOGGLE_H
#define UMICOM_EDITOR_FEATURES_COMMENT_TOGGLE_H
...
/** Return the canonical Framework descriptor for Comment Toggle. */
...
#endif /* UMICOM_EDITOR_FEATURES_COMMENT_TOGGLE_H */
