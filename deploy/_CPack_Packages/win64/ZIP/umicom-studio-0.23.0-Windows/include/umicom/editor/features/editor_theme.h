/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/editor_theme.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Editor Theme editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Token, surface and accessibility colour roles.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_EDITOR_THEME_H
#define UMICOM_EDITOR_FEATURES_EDITOR_THEME_H
...
/** Return the canonical Framework descriptor for Editor Theme. */
...
#endif /* UMICOM_EDITOR_FEATURES_EDITOR_THEME_H */
