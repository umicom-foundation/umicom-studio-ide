/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/recent_editors.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Recent Editors editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Most recently used editor traversal and reopening.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_RECENT_EDITORS_H
#define UMICOM_EDITOR_FEATURES_RECENT_EDITORS_H
...
/** Return the canonical Framework descriptor for Recent Editors. */
...
#endif /* UMICOM_EDITOR_FEATURES_RECENT_EDITORS_H */
