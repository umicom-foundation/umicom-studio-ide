...
#include <assert.h>
#include <string.h>
#include "security_centre_v2_fixture.h"
#include "umicom/studio/security_audit_view_v2.h"
...
int main(void)
{
    ...
    assert(umi_studio_security_authorise_v2(centre,&request,&decision) == UMI_STATUS_OK);
