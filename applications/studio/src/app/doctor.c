                                ...
                                UmiStudioDoctorReport *out_report)
{
    static const char *required_files[] = {
        ...
        "framework/include/umicom/platform/settings.h",
        "framework/src/platform/settings.c",
        ...
        "applications/studio/src/app/settings.c",
        ...
        "applications/studio/include/umicom/studio/settings.h",
        "applications/studio/src/tools/doctor_main.c",
        "applications/studio/src/tools/diagnostics_main.c",
        "applications/studio/src/tools/settings_main.c",
        "applications/studio/tests/test_diagnostics.c",
        "applications/studio/tests/test_settings.c",
        ...
        "docs/FEATURE_DEVELOPMENT_PLAN_0.13.0.md",
        "docs/adr/ADR-0005-typed-settings-and-windows-toolchain.md",
        "docs/migration/FRAMEWORK_DEPENDENCY_MATRIX_0.13.0.md"
    };
