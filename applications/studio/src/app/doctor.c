                                ...
                                UmiStudioDoctorReport *out_report)
{
    static const char *required_files[] = {
        ...
        "framework/docs/MAJOR_RELEASE_SCOPE_0.5.0.md",
        "framework/docs/PUBLIC_API_CATALOGUE_0.5.0.md",
        "framework/docs/COMMAND_REFERENCE_0.5.0.md",
        ...
        "docs/MAJOR_RELEASE_PLAN_0.14.0.md",
        "docs/FRAMEWORK_CAPABILITY_MATRIX_0.14.0.md",
        "docs/BUILD_AND_VALIDATE_0.14.0.md",
