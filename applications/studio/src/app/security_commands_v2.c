...
#include "umicom/studio/security_approvals_v2.h"
#include "umicom/studio/security_identities_v2.h"
#include "umicom/studio/security_packages_v2.h"
#include "umicom/studio/security_secrets_v2.h"
#include <string.h>
                           ...
                           UmiSecurityGovernanceDecision *out_decision)
{
    ...
    return umi_studio_security_authorise_v2(centre,&request,out_decision);
}
