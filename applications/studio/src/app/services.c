 ...
 *   The retained diagnostic store is registered before optional presentation
 *   sinks so lifecycle messages remain available to console and future GTK4
 *   diagnostic views.
 *
    ...
    UmiStudioServices **out_services)
{
    ...
    *out_services = NULL;
    ...
    store_config.capacity = UMI_STUDIO_DIAGNOSTIC_STORE_CAPACITY;
