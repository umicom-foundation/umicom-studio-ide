...
{
    UmiOperationsCentre *operations = umi_studio_operations_centre_v2_engine(centre);
...
UmiStatus umi_studio_operations_execute_v2(UmiStudioOperationsCentreV2 *centre,UmiStudioOperationsCommandV2 command,const char *argument)
{
    ...
    switch (command) {
        case UMI_STUDIO_OPERATIONS_COMMAND_SEED: return umi_studio_operations_seed_v2(centre);
        ...
        case UMI_STUDIO_OPERATIONS_COMMAND_OPEN_PROFILER: return umi_studio_operations_centre_v2_activate(centre,"profiler");
