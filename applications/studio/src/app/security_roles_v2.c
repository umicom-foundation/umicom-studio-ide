...
#include "umicom/studio/security_roles_v2.h"
...
UmiStatus umi_studio_security_authorise_v2(UmiStudioSecurityCentre *centre,const UmiSecurityAccessRequest *request,UmiSecurityGovernanceDecision *out_decision) { return centre == NULL ? UMI_STATUS_INVALID_ARGUMENT : revised(centre,umi_security_governance_authorise(&centre->governance,request,out_decision)); }
