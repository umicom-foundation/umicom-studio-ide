/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/large_file_mode.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Large File Mode editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Memory-budgeted editing mode that disables expensive decorations safely.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_LARGE_FILE_MODE_H
#define UMICOM_EDITOR_FEATURES_LARGE_FILE_MODE_H
...
/** Return the canonical Framework descriptor for Large File Mode. */
...
#endif /* UMICOM_EDITOR_FEATURES_LARGE_FILE_MODE_H */
