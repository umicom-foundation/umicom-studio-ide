/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/case_transform.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Case Transform editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Upper, lower, title, snake and camel case transformations.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_CASE_TRANSFORM_H
#define UMICOM_EDITOR_FEATURES_CASE_TRANSFORM_H
...
/** Return the canonical Framework descriptor for Case Transform. */
...
#endif /* UMICOM_EDITOR_FEATURES_CASE_TRANSFORM_H */
