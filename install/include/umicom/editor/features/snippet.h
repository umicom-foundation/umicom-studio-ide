/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/snippet.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Snippet editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Snippet templates, variables, choices and tab-stop traversal.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_SNIPPET_H
#define UMICOM_EDITOR_FEATURES_SNIPPET_H
...
/** Return the canonical Framework descriptor for Snippet. */
...
#endif /* UMICOM_EDITOR_FEATURES_SNIPPET_H */
