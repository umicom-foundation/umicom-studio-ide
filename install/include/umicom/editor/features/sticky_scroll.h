/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/sticky_scroll.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Sticky Scroll editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Pinned enclosing symbols at the top of the viewport.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_STICKY_SCROLL_H
#define UMICOM_EDITOR_FEATURES_STICKY_SCROLL_H
...
/** Return the canonical Framework descriptor for Sticky Scroll. */
...
#endif /* UMICOM_EDITOR_FEATURES_STICKY_SCROLL_H */
