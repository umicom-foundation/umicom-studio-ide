/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/collaborative_cursor.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Collaborative Cursor editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Presence, remote selections and participant identity.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_COLLABORATIVE_CURSOR_H
#define UMICOM_EDITOR_FEATURES_COLLABORATIVE_CURSOR_H
...
/** Return the canonical Framework descriptor for Collaborative Cursor. */
...
#endif /* UMICOM_EDITOR_FEATURES_COLLABORATIVE_CURSOR_H */
