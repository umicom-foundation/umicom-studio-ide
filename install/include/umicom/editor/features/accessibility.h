/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/accessibility.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Accessibility editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Screen-reader, keyboard, contrast and motion preferences.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_ACCESSIBILITY_H
#define UMICOM_EDITOR_FEATURES_ACCESSIBILITY_H
...
/** Return the canonical Framework descriptor for Accessibility. */
...
#endif /* UMICOM_EDITOR_FEATURES_ACCESSIBILITY_H */
