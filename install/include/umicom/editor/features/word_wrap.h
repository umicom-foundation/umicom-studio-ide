/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/word_wrap.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Word Wrap editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Off, viewport, bounded-column and indentation-aware wrapping.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_WORD_WRAP_H
#define UMICOM_EDITOR_FEATURES_WORD_WRAP_H
...
/** Return the canonical Framework descriptor for Word Wrap. */
...
#endif /* UMICOM_EDITOR_FEATURES_WORD_WRAP_H */
