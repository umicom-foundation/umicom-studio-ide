/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/quick_open.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Quick Open editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Ranked workspace resource search and recently used items.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_QUICK_OPEN_H
#define UMICOM_EDITOR_FEATURES_QUICK_OPEN_H
...
/** Return the canonical Framework descriptor for Quick Open. */
...
#endif /* UMICOM_EDITOR_FEATURES_QUICK_OPEN_H */
