/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/document_loader.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Document Loader editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Provider-neutral asynchronous document loading contract.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_DOCUMENT_LOADER_H
#define UMICOM_EDITOR_FEATURES_DOCUMENT_LOADER_H
...
/** Return the canonical Framework descriptor for Document Loader. */
...
#endif /* UMICOM_EDITOR_FEATURES_DOCUMENT_LOADER_H */
