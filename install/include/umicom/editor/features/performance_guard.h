/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/performance_guard.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Performance Guard editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Latency and memory budgets for providers and decorations.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_PERFORMANCE_GUARD_H
#define UMICOM_EDITOR_FEATURES_PERFORMANCE_GUARD_H
...
/** Return the canonical Framework descriptor for Performance Guard. */
...
#endif /* UMICOM_EDITOR_FEATURES_PERFORMANCE_GUARD_H */
