/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/inline_completion.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Inline Completion editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Ghost-text completions with partial acceptance.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_INLINE_COMPLETION_H
#define UMICOM_EDITOR_FEATURES_INLINE_COMPLETION_H
...
/** Return the canonical Framework descriptor for Inline Completion. */
...
#endif /* UMICOM_EDITOR_FEATURES_INLINE_COMPLETION_H */
