/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/signature_help.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Signature Help editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Callable signatures, active parameter and documentation.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_SIGNATURE_HELP_H
#define UMICOM_EDITOR_FEATURES_SIGNATURE_HELP_H
...
/** Return the canonical Framework descriptor for Signature Help. */
...
#endif /* UMICOM_EDITOR_FEATURES_SIGNATURE_HELP_H */
