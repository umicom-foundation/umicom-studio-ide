/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/literal_search.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Literal Search editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Forward and reverse literal search with case policy.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_LITERAL_SEARCH_H
#define UMICOM_EDITOR_FEATURES_LITERAL_SEARCH_H
...
/** Return the canonical Framework descriptor for Literal Search. */
...
#endif /* UMICOM_EDITOR_FEATURES_LITERAL_SEARCH_H */
