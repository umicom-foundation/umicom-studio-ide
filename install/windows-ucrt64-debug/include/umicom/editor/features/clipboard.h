/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/clipboard.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Clipboard editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Plain-text and structured multi-selection clipboard payloads.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_CLIPBOARD_H
#define UMICOM_EDITOR_FEATURES_CLIPBOARD_H
...
/** Return the canonical Framework descriptor for Clipboard. */
...
#endif /* UMICOM_EDITOR_FEATURES_CLIPBOARD_H */
