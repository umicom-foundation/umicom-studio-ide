/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/navigation_history.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Navigation History editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Back, forward and last-edit location history.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_NAVIGATION_HISTORY_H
#define UMICOM_EDITOR_FEATURES_NAVIGATION_HISTORY_H
...
/** Return the canonical Framework descriptor for Navigation History. */
...
#endif /* UMICOM_EDITOR_FEATURES_NAVIGATION_HISTORY_H */
