/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/document_recovery.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Document Recovery editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Crash-safe hot-exit journal and recovery candidate model.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_DOCUMENT_RECOVERY_H
#define UMICOM_EDITOR_FEATURES_DOCUMENT_RECOVERY_H
...
/** Return the canonical Framework descriptor for Document Recovery. */
...
#endif /* UMICOM_EDITOR_FEATURES_DOCUMENT_RECOVERY_H */
