/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/remote_document.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Remote Document editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Remote URI loading, latency and connection-state model.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_REMOTE_DOCUMENT_H
#define UMICOM_EDITOR_FEATURES_REMOTE_DOCUMENT_H
...
/** Return the canonical Framework descriptor for Remote Document. */
...
#endif /* UMICOM_EDITOR_FEATURES_REMOTE_DOCUMENT_H */
