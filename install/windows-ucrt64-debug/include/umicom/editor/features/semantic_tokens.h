/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/semantic_tokens.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Semantic Tokens editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Full and delta semantic token transfer model.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_SEMANTIC_TOKENS_H
#define UMICOM_EDITOR_FEATURES_SEMANTIC_TOKENS_H
...
/** Return the canonical Framework descriptor for Semantic Tokens. */
...
#endif /* UMICOM_EDITOR_FEATURES_SEMANTIC_TOKENS_H */
