/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/diagnostic_collection.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Diagnostic Collection editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Versioned diagnostic ownership by provider and document.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_DIAGNOSTIC_COLLECTION_H
#define UMICOM_EDITOR_FEATURES_DIAGNOSTIC_COLLECTION_H
...
/** Return the canonical Framework descriptor for Diagnostic Collection. */
...
#endif /* UMICOM_EDITOR_FEATURES_DIAGNOSTIC_COLLECTION_H */
