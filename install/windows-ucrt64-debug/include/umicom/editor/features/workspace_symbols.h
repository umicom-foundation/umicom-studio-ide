/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/workspace_symbols.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Workspace Symbols editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Ranked symbol search across workspace providers.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_WORKSPACE_SYMBOLS_H
#define UMICOM_EDITOR_FEATURES_WORKSPACE_SYMBOLS_H
...
/** Return the canonical Framework descriptor for Workspace Symbols. */
...
#endif /* UMICOM_EDITOR_FEATURES_WORKSPACE_SYMBOLS_H */
