/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/breadcrumb_navigation.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Breadcrumb Navigation editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   File and symbol breadcrumb segments with commands.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_BREADCRUMB_NAVIGATION_H
#define UMICOM_EDITOR_FEATURES_BREADCRUMB_NAVIGATION_H
...
/** Return the canonical Framework descriptor for Breadcrumb Navigation. */
...
#endif /* UMICOM_EDITOR_FEATURES_BREADCRUMB_NAVIGATION_H */
