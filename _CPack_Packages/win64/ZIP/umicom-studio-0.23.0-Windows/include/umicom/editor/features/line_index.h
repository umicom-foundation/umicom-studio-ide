/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/line_index.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Line Index editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Offset-to-line and line-to-offset navigation over editor snapshots.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_LINE_INDEX_H
#define UMICOM_EDITOR_FEATURES_LINE_INDEX_H
...
/** Return the canonical Framework descriptor for Line Index. */
...
#endif /* UMICOM_EDITOR_FEATURES_LINE_INDEX_H */
