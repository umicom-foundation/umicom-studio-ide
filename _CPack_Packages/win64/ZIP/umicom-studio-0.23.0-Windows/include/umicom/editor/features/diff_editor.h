/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/diff_editor.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Diff Editor editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Inline and side-by-side diff presentation state.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_DIFF_EDITOR_H
#define UMICOM_EDITOR_FEATURES_DIFF_EDITOR_H
...
/** Return the canonical Framework descriptor for Diff Editor. */
...
#endif /* UMICOM_EDITOR_FEATURES_DIFF_EDITOR_H */
