/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/language_status.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Language Status editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Language-service health and document status items.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_LANGUAGE_STATUS_H
#define UMICOM_EDITOR_FEATURES_LANGUAGE_STATUS_H
...
/** Return the canonical Framework descriptor for Language Status. */
...
#endif /* UMICOM_EDITOR_FEATURES_LANGUAGE_STATUS_H */
