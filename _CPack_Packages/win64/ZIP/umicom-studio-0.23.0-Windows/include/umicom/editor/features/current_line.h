/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/current_line.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Current Line editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Active line, range and gutter highlighting policy.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_CURRENT_LINE_H
#define UMICOM_EDITOR_FEATURES_CURRENT_LINE_H
...
/** Return the canonical Framework descriptor for Current Line. */
...
#endif /* UMICOM_EDITOR_FEATURES_CURRENT_LINE_H */
