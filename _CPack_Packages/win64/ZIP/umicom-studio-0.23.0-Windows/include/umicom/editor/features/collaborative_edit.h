/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/collaborative_edit.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Collaborative Edit editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Causally ordered remote edit operation boundary.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_COLLABORATIVE_EDIT_H
#define UMICOM_EDITOR_FEATURES_COLLABORATIVE_EDIT_H
...
/** Return the canonical Framework descriptor for Collaborative Edit. */
...
#endif /* UMICOM_EDITOR_FEATURES_COLLABORATIVE_EDIT_H */
