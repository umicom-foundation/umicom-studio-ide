/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/go_to_symbol.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Go To Symbol editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Document and workspace symbol navigation result model.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_GO_TO_SYMBOL_H
#define UMICOM_EDITOR_FEATURES_GO_TO_SYMBOL_H
...
/** Return the canonical Framework descriptor for Go To Symbol. */
...
#endif /* UMICOM_EDITOR_FEATURES_GO_TO_SYMBOL_H */
