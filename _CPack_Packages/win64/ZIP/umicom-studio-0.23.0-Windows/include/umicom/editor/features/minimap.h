/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/minimap.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Minimap editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Scaled document overview and viewport interaction model.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_MINIMAP_H
#define UMICOM_EDITOR_FEATURES_MINIMAP_H
...
/** Return the canonical Framework descriptor for Minimap. */
...
#endif /* UMICOM_EDITOR_FEATURES_MINIMAP_H */
