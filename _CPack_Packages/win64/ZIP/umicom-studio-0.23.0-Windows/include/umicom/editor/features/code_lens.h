/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/code_lens.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Code Lens editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Actionable reference, test and ownership annotations above code.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_CODE_LENS_H
#define UMICOM_EDITOR_FEATURES_CODE_LENS_H
...
/** Return the canonical Framework descriptor for Code Lens. */
...
#endif /* UMICOM_EDITOR_FEATURES_CODE_LENS_H */
