/*-----------------------------------------------------------------------------
 * Umicom Framework
 * File: include/umicom/editor/features/document_symbols.h
 *
 * PURPOSE:
 *   Publish the product-neutral descriptor for the Document Symbols editor capability.
 *
 ...
 *
 * FEATURE CONTRACT:
 *   Hierarchical document outline and symbol ranges.
 *
 * LIFETIME:
 ...
 */
#ifndef UMICOM_EDITOR_FEATURES_DOCUMENT_SYMBOLS_H
#define UMICOM_EDITOR_FEATURES_DOCUMENT_SYMBOLS_H
...
/** Return the canonical Framework descriptor for Document Symbols. */
...
#endif /* UMICOM_EDITOR_FEATURES_DOCUMENT_SYMBOLS_H */
